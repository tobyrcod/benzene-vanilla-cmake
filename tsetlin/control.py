...
class WinnerPredModel:
    ...
    # BEST_TYPE_WEIGHTS = [0.0, 0.13, 0.14, 0.84]  # X6_BASELINE
    BEST_TYPE_WEIGHTS = [-0.06, 0.13, 0.20, 0.96]

    @staticmethod
    def predict_winners_for_dataset(dataset: UtilsDataset.Dataset, type_weights=None):
    ...
    @staticmethod
    def _find_best_type_weights(dataset: UtilsDataset.Dataset):
        ...
        def objective(**params):
            ...
            y_pred, boards_with_matches = WinnerPredModel.predict_winners_for_dataset(dataset, type_weights)
...
class WinnerPredGA:
    ...
    def evaluate(individual):
        ...
        """
        type_weights = individual

        dataset = UtilsDataset.X6_BASELINE
...
if __name__ == '__main__':
    ...
    # UtilsHex.SearchPattern.calculate_matches_in_dataset(dataset)
    WinnerPredModel._find_best_type_weights(dataset)